...
public:
	...
	// accessors:
	const MPI_Datatype &get_mpi_datatype() const
	{
		return mpi_dt;
	}
	const int get_extent() const
	{
		return extent;
	}
	const bool get_associative() const
	{
		return associative;
	}
	const bool get_weakassociative() const
	{
		return weakassociative;
	}
	const bool get_commutative() const
	{
		return commutative;
	}
...
public:
	...
	static void add_builtin_datatype (Datatype dt)
	{
	...
	static const Datatype *get_properties(const MPI_Datatype &dt)
	{
		try
		{
			return &builtins->at(dt);
		}
